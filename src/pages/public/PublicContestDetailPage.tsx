      ...
      {!contest ? (
        ...
        <div className="space-y-8">
          ...
          <Tabs
            ...
            className="space-y-6"
          >
            <TabsList className="flex w-full flex-wrap gap-2 rounded-2xl border border-slate-200 bg-white p-2 shadow-sm">
              <TabsTrigger value="overview" className="rounded-xl px-4 py-2.5">
                Tổng quan
              </TabsTrigger>
              <TabsTrigger value="matches" className="rounded-xl px-4 py-2.5">
                Trận đấu
              </TabsTrigger>
              <TabsTrigger
                value="leaderboard"
...
function ContestHero({
  ...
  return (
    <section className="overflow-hidden rounded-[32px] border border-slate-200 bg-white shadow-sm">
      <div className="relative min-h-[320px] overflow-hidden bg-slate-900 p-8 text-white sm:p-10">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(251,146,60,0.42),transparent_30%),linear-gradient(135deg,rgba(2,6,23,0.98),rgba(15,23,42,0.9)_55%,rgba(124,45,18,0.62))]" />
        <div className="relative z-10 max-w-4xl">
          ...
          <p className="mt-4 max-w-2xl whitespace-pre-line text-sm leading-7 text-slate-200">
